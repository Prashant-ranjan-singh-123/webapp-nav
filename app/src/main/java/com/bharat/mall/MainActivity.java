...
public class MainActivity extends AppCompatActivity {
    String websiteURL = "https://www.google.com"; // sets web url
        ...
        public void print() {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(com.bharat.mall.MainActivity.this, "Printing...", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
...
//            setContentView(R.layout.activity_main);
            Intent nointernet=new Intent(com.bharat.mall.MainActivity.this,noInternet.class);
...
//            webview.getSettings().setJavaScriptEnabled(true);
            ...
            webview.setWebViewClient(new com.bharat.mall.MainActivity.WebViewClientDemo());
            ...
            webview.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if(!com.bharat.mall.CheckNetwork.isInternetAvailable(getBaseContext())) {
                        ...
                        Intent intent = new Intent(com.bharat.mall.MainActivity.this, noInternet.class);
                        startActivity(intent);
                    }
                    else {
                        webview.reload();
        ...
        webview.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
                ...
                try {
                    ...
                    Toast.makeText(com.bharat.mall.MainActivity.this, "Cannot open file chooser", Toast.LENGTH_SHORT).show();
                    return false;
                }
                return true;
            }
...
class CheckNetwork {
    ...
    private static final  String TAG = com.bharat.mall.CheckNetwork.class.getSimpleName();
